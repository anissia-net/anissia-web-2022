      ...
      <div v-if="mode == 'none'"  class="p-6 w-[90vw] max-w-[540px] min-w-[300px] rounded-md shadow bg-white dark:bg-zinc-900/50 dark:border-zinc-800">
        <div class="space-y-4 md:space-y-6">
          <div>
            ...
            <input type="email" v-model="email" name="email" class="outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:border-blue-600 block w-full p-2.5 dark:bg-zinc-900 dark:border-zinc-800 dark:placeholder-gray-400 dark:text-white dark:focus:border-zinc-300" placeholder="user@example.com">
          </div>
          <div>
