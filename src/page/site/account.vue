      ...
      <table class="w-full text-sm text-left text-zinc-500 dark:text-zinc-400">
        ...
        <tr v-if="mode == 'edit-nickname'" class="bg-white border-b dark:bg-zinc-900 dark:border-zinc-800">
          ...
          <td class="py-4 px-6">
            <div class="max-w-[300px]">
              <div>
                <input type="text" v-model="editNickname" name="nickname" class="outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:border-blue-600 block w-full p-2.5 dark:bg-zinc-900 dark:border-zinc-800 dark:placeholder-gray-400 dark:text-white dark:focus:border-zinc-300" placeholder="닉네임">
              </div>
              <div class="mt-3">
                <input type="password" v-model="editNicknamePassword" name="password" placeholder="암호" class="outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:border-blue-600 block w-full p-2.5 dark:bg-zinc-900 dark:border-zinc-800 dark:placeholder-gray-400 dark:text-white dark:focus:border-zinc-300">
              </div>
              <div class="mt-3">
        ...
        <tr v-if="mode == 'edit-password'" class="bg-white border-b dark:bg-zinc-900 dark:border-zinc-800">
          ...
          <td class="py-4 px-6">
            <div class="max-w-[300px]">
              <div>
                <input type="password" v-model="editPrevPassword" name="password" placeholder="기존 암호" class="outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:border-blue-600 block w-full p-2.5 dark:bg-zinc-900 dark:border-zinc-800 dark:placeholder-gray-400 dark:text-white dark:focus:border-zinc-300">
              </div>
              <div class="mt-3">
                <input type="password" v-model="editPassword" name="password1" placeholder="새 암호" class="outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:border-blue-600 block w-full p-2.5 dark:bg-zinc-900 dark:border-zinc-800 dark:placeholder-gray-400 dark:text-white dark:focus:border-zinc-300">
              </div>
              <div class="mt-3">
                <input type="password" v-model="editPasswordConfirm" name="password2" placeholder="새 암호 확인" class="outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:border-blue-600 block w-full p-2.5 dark:bg-zinc-900 dark:border-zinc-800 dark:placeholder-gray-400 dark:text-white dark:focus:border-zinc-300">
              </div>
              <div class="mt-3">
