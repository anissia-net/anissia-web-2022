<template>
  <div>
    <div class="flex mb-2">
      ...
      <div class="flex-1 text-center py-3 border-b-2 border-transparent hover:border-gray-500 dark:hover:border-gray-300 cursor-pointer duration-300" :class="({'border-gray-400 dark:border-gray-500': period === 'month'})" @click="load('month')">월간</div>
